...
> **Equipment Note:** The combination of the Gatlin Bow and Magic Quiver will turn your archer/mage into the deadliest short-range fighter in the party. If you don't use Quickfight, you can have her fire on Full Auto, which fires all 63 arrows at once. Even accounting for misses and a paltry 1d4 per arrow, that's likely to come out around **50 HP of damage** so long as the target's within 20', *plus* the Quiver automatically refills itself after every round.
