...
- **Lasering the ground:** Sandstone Shards
- **Regolith Spire**: Regolith, Regolith Chunks
- **Loose Scrap**: Metal Scrap
...
### Lost World: Epsilon
Broadly covering the upper, central region.
- **Bladestone Node** (cyan): Deepstone, Bladestone, Tangrite Geode
...
### Lost World: Lambda and Mu
The swampy region with all the dinosaur bones. Glowing Bulbs are really only available near Mu.
- **Bladestone Node** (cyan): Deepstone, Bladestone, Tangrite Geode
- **Deepstone Node** (neutral): Deepstone, Bladestone
- **Gold Node** (gold): Gold Ore, Deepstone, Bladestone, Sky Sapphire, Gold Geode
- **Greatwood Node** (brown): Greatwood, Living Amber
- **Jaspite Node** (blue): Jaspite Ore, Deepstone, Bladestone, Jaspite Geode, Sky Sapphire, Vitaglass
- **Swamp Node** (purple flowers): Jaspite Ore, Deepstone, Bladestone, Vitaglass, Swamp Geode
- **Tangrite Node** (purple): Tangrite Ore, Deepstone, Bladestone, Foucer Crytsal, Tangrite Geode
- **Glowing Bulb Plant**: Glowing Bulb
- **Swampwheat**: Swampwheat
...
- **Mycelial Tower**: Mycelial Biomass, Hive Mycelia
