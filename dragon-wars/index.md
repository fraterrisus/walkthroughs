...
This walkthrough is dedicated to the memory of Rebecca "Burger Becky" Heineman, the original designer and developer of _Dragon Wars_, who died of cancer in November of 2025. Becky's history of reverse engineering, not to mention her incredibly long list of accomplishments as a developer, is a major source of inspiration for me.
...
*Dragon Wars* is a classic CRPG, developed and published by **Interplay**, that stands as the spiritual successor to the *Bard's Tale* series and one of my favorite CRPGs of all time. In fact, it was originally developed with an eye towards becoming *Bard's Tale IV*, with a similar combat model but several significant improvements to the overall engine. Of course, the Bryan Fargo-led **inXile Entertainment** would eventually produce a very successful and very modern *BT4* game several decades later, which I highly recommended. But I digress. Check out the [Wikipedia page](https://en.wikipedia.org/wiki/Dragon_Wars) for more history and introduction, along with a link to the Internet Archive where you can play it in-browser if you don't have any other options.
...
You'll also find a list of spells in the manual, but you won't need it because I've [listed them all here](/dragon-wars/magic) along with more information than is available there. You should also be aware that there are several red herrings and/or places where the manual is simply incorrect, whether intentional or not.

At the end of the manual is a list of paragraphs. You should be able to find a text file containing the paragraphs online, rather than having to squint at some poorly-scanned PDF version. These help flesh out the story as you go, and give you some hints and other bits of direction. In the walkthrough I've marked the places where the game directs you to the paragraph list with `(pxxx)`, where `xxx` is the paragraph number. Careful, not all the paragraphs are real — this was a common "copy protection" scheme in those days. But even the fake paragraphs are often funny and worth reading. I've listed out which ones are fake in the [appendices](#fake-paragraphs), if you're curious.

### DragonJars

Over the time that I've been writing and maintaining this walkthrough, I've managed to rip apart the game's original binaries and data files and learn just about everything there is to learn about them. Eventually, I decided that the best thing to do with this information was to make a "super-emulator" which allows you to not only play the game (presuming you have a _legal_ copy of the data files), but also fixes some bugs and adds some quality-of-life improvements that makes it even more fun to play.
...
You definitely want to take *Lockpick*: one rank is pretty much required and three gets you through basically everything (see [Game Mechanics](#game-mechanics)). I recommend building up to *Lockpick 3* in time to clean out the second Guard Bridge.
...
Side note: I don't know what genius picked those damage dice, but going from 5–40 at rank 5 to 3–30 at rank 6 and 3–36 at rank 7 is pretty dumb.
...
If you hit with Mighty Attack, roll an additional 1d4.
...
Monsters pick their action each turn based on their **morale**, whether or not they've been **attacked** or **damaged**, and whether or not they're **in range** for a melee attack. In the "Bestiary" sections of the [map data](/dragon-wars/maps/) I've listed each individual monster's possible actions, but for the sake of simplicity I've left out any indication of which ones are most likely to happen. It's pretty common for the same action to exist multiple times in different flavors; in particular, monster's melee damage often changes (and frequently goes _up_) after the monster has been damaged.
