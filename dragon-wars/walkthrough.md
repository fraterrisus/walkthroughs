...
Assuming you're starting at the Purgatory stairs, here are some other points of interest in the Underworld:
...
3. **Exposition Cavern:** From the Purgatory stairs, go 2W then S. Walk through the fire (ow) and find the locked chest (difficulty 3) with The Slicer (1d30, +4 AV, +2 AC) in it. 1W 3S from the chest, there are stairs up to the Dwarf Clan Hall forge. 5N 1E from the chest, there's a cavern that tells you some background on your mission `(p127)`.
4. **Irkalla's Realm:** From the Lansk building, go E. Hug the chasm wall and you'll come to a door. So long as you've sacrificed something to Irkalla at one of her statues topside, you'll be allowed through. Go 2W and N from there, then take a leap of faith N. Everyone in the party gets 5 AP, but you can only do this once per game. (Of course, you can start a new game with the same characters and do it again... but that would be """cheating""".) While you're here, explore the rest of her realm and notice the spot on the E shore where there seems to be a nearby island. You can't do anything about this right now, but we'll come back to it.
...
8. **Magic Items:** From the Mystic Wood stairs, go 4S 4W for a locked chest (difficulty 3): 10 Dragon Stones, the Rusty Axe (1d20, -3 AV), some Bombs (thrown weapons are trash), and a Speed Wand (casts *M:Zak's Speed,* which is super-useful). Careful, there is likely to be a significant battle with Underworld denizens here.
...
Remember the bar where you picked up Valar? Go W from there. First you'll hit a bunch of rats. The wild dogs just past them will give you a little bit of a harder time. Beyond that is a room with a locked chest (difficulty 1). You can give the Mage Cloth to your archer/mage; +3 AC and the lack of an AV penalty is probably worth it. Magic Plate (+10 AC, -2 AV) will do nicely for a front line fighter. Ignore the Fire Spear (1d12 at 50'); thrown weapons aren't worth the time it takes to equip them.
...
Hopefully, when you were exploring Irkalla's Realm before you spotted the island off the E shore. Head back to that point and `(U)se` the Golden Boots to hop over to the Isle of Woe, where you'll find a hot chick in chains `(p137)`. Irkalla will ask you to find the Silver Key and promises to help you defeat Namtar if you do. If you don't have any idea who might have such an object (and why would you), head over to [Exposition Cavern](#magan-underworld-highlights) for a hint.
...
To the E is a locked door (level 1), and beyond it are more guards. Or, instead of going through the door, you can go 1S 1E, `(U)se` Intelligence or *Mountain Lore*, then `(U)se` *Climb*, and skip the fight. Your choice.
